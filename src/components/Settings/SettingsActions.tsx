...
export const SettingsActions = () => {
	...
	return (
		<>
			...
			<IconBtn icon={<DeleteForeverIcon />} text="Clear All Settings" onClick={() => setIsConfirmOpen(true)} />
			<ConfirmClearDialog open={isConfirmOpen} onClose={() => setIsConfirmOpen(false)} onConfirm={handleConfirmClear} />
			<ExportDialog open={isExportOpen} onClose={() => setIsExportOpen(false)} onExport={handleExport} />
		</>
	)
}
