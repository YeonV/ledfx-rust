						...
						case 'slider':
							...
							return (
								<Stack
									direction={'row'}
									key={setting.id}
									sx={{ mt: 2, flexBasis: '100%', justifyContent: 'space-between', alignItems: 'center' }}
								>
									<Typography variant="caption" gutterBottom sx={{ width: 100 }}>
										{setting.name}
									</Typography>
									<Slider
										value={Number(value)}
