...
export const Bottom = () => <path fill="currentColor" strokeLinejoin="bevel" strokeMiterlimit="22.9256" d="M22751.73 30209.19l-4508.17 1605.87c6186.94,5970.28 15978.27,5978.16 22158.89,1.34l-4508.57 -1606.03c-3977.4,2650.87 -9163.74,2648.16 -13142.15,-1.18z" />
export const Top = () => <path fill="currentColor" strokeLinejoin="bevel" strokeMiterlimit="22.9256" d="M22802.89 10449.6l-4523.5 -1606.47c6163.23,-5924.29 15916.39,-5917.68 22087.23,-1.33l-4523.9 1606.62c-3958.6,-2605.67 -9083.15,-2607.37 -13039.83,1.18z" />
export const Y = () => <polygon fill="currentColor" strokeLinejoin="bevel" strokeMiterlimit="22.9256" points="11616.1,8249.12 11616.1,22417.04 24322.12,22417.04 24322.12,23326 15789.82,26458.12 15789.82,24700.98 11610.12,26235.29 11610.12,32404.98 28502.47,26387.7 28502.47,14246.16 22571.24,12139.74 22571.24,16618.6 24322.12,17196.7 24322.12,18147.8 15830.96,18147.8 15830.96,14182.39 17568.29,14856.66 17568.29,10363 " />
export const Z = () => <polygon fill="currentColor" strokeLinejoin="bevel" strokeMiterlimit="22.9256" points="47093.19,8225.33 30139.81,14246.16 30139.81,16475.31 36517.25,16475.31 42851.53,14225.75 42851.53,18170.76 30139.81,18170.76 30139.81,26387.7 47093.19,32426.72 47093.19,24108.92 42820.02,24108.92 42820.02,24487.97 42820.02,26458.31 34335.23,23420.94 34335.23,22451.01 47093.19,22451.01 " />

interface YZLogo2Props {
  style?: Record<string, unknown> | CSSProperties,
 }

export const YZLogo2Bottom = ({ style }:YZLogo2Props) => (
...
export const YZLogo2Top = ({ style }:YZLogo2Props) => (
  <svg style={{ transform: 'scale(0.025)', marginTop: '8px', transformOrigin: 'top left', ...style }} xmlns="http://www.w3.org/2000/svg" width="594mm" height="420mm" version="1.1" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd"
    viewBox="0 0 59400 42000">
    <g id="_0" style={{ transformOrigin: 'center', transform: 'scale(1.3' }}>
      <g id="YZLogo2Top">
...
export const YZLogo2Y = ({ style }:YZLogo2Props) => (
...
export const YZLogo2Z = ({ style }:YZLogo2Props) => (
...
export const YZLogo2 = ({ style }:YZLogo2Props) => (
  <svg style={{ marginRight: '8px', transformOrigin: 'top left', width: '24px', height: '24px', ...style }} xmlns="http://www.w3.org/2000/svg" width="594mm" height="420mm" version="1.1" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd"
    viewBox="0 0 59400 42000">
    <g id="_0" style={{ transformOrigin: 'center', transform: 'scale(1.3' }}>
      <g id="YZLogo2">
        <Z />
