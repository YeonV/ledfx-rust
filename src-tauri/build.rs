...
//         // --- START: THE NEW HELPER FUNCTION ---
//         writeln!(file, "pub fn config_to_value(config: EffectConfig) -> Value {{")?;
//         writeln!(file, "    match config {{")?;
//         for effect in &effects {
//             let variant_name = effect.to_upper_camel_case();
//             writeln!(file, "        EffectConfig::{}(c) => serde_json::to_value(c).unwrap(),", variant_name)?;
//         }
//         writeln!(file, "    }}\n}}")?;
//         // --- END: THE NEW HELPER FUNCTION ---
//     }
